      ...
      <div className="flex flex-row w-full">
        <div className="hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg">
          <div className="flex items-center justify-start space-x-3">
            <HydraseLogo className="w-12 h-12" />
          </div>
          <div className="space-y-5">
            <h1 className="lg:text-3xl xl:text-5xl xl:leading-snug font-extrabold text-left">
              Dive into the world of Hydrase and discover new experiences
            </h1>
          ...
          <p className="font-medium">© 2023 Hydrase. All rights reserved.</p>
        </div>
